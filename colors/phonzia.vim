...
:hi Statement guifg=gold ctermfg=brown gui=italic
:hi Visual gui=none guifg=khaki guibg=olivedrab cterm=reverse
:hi WarningMsg guifg=salmon ctermfg=1
:hi String  guifg=#ee3b3b ctermfg=darkcyan
:hi Comment term=italic ctermfg=11  guifg=Grey40 gui=italic
:hi Constant guifg=#ffa0a0 ctermfg=DarkRed gui=italic
:hi Special guifg=darkkhaki ctermfg=brown
:hi Identifier guifg=salmon ctermfg=red
:hi Include guifg=DarkRed ctermfg=red
:hi PreProc guifg=red ctermfg=red
:hi Operator guifg=goldenrod ctermfg=brown
:hi Define guifg=gold gui=bold ctermfg=brown
:hi Type guifg=CornflowerBlue ctermfg=lightblue gui=italic
:hi Function guifg=SeaGreen gui=italic ctermfg=darkgreen
